...
export default class DataBaseSqlLite {
  ...
  async get_value(document, field, name, distinct_to_id = null, if_not_found = "throw") {
  ...
  async get_doc(document, name, fields = ['*'], is_single = false) {
    return await this.get_row(document, name, fields, is_single);
  }
