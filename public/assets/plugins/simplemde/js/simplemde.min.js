   ...
   return function t(e, n, r) {
      ...
      10: [function (t, n, r) {
         !function (t) {
            ...
            function We(e, t, n) {
               ...
               if (f.line == h.line) i(f.line, f.ch, h.ch); else {
                  var d = Zr(a, f.line), p = Zr(a, h.line), m = yr(d) == yr(p),
                     g = i(f.line, f.ch, m ? d.text.length + 1 : null).end, v = i(h.line, m ? 0 : null, h.ch).start;
            ...
            var po = navigator.userAgent, mo = navigator.platform, go = /gecko\/\d/i.test(po), vo = /MSIE \d/.test(po),
               yo = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(po), xo = vo || yo,
            ...
            var zo, jo, Uo, qo = { left: 0, right: 0, top: 0, bottom: 0 }, Go = null, Yo = 0, $o = 0, Vo = 0, Ko = null;
            ...
            e.prototype = {
               ...
               }, triggerOnKeyDown: Ot(hn), triggerOnKeyPress: Ot(mn), triggerOnKeyUp: pn, execCommand: function (e) {
      ...
      12: [function (t, n, r) {
         !function (i) {
            ...
            e.defineMode("markdown", function (t, n) {
               ...
               var L = /^([*\-_])(?:\s*\1){2,}\s*$/, T = /^[*\-+]\s+/, M = /^[0-9]+([.)])\s+/, N = /^\[(x| )\](?=\s)/,
                  A = n.allowAtxHeaderWithoutSpace ? /^(#+)/ : /^(#+)(?: |$)/, E = /^ *(?:\={1,}|-{1,})\s*$/,
                  O = /^[^#!\[\]*_\\<>` "'(~]+/,
      ...
      20: [function (e, t, n) {
         ...
         function h(e) {
            ...
            var o, a, l, s = e.options.blockStyles.code, c = e.codemirror, u = c.getCursor("start"),
               f = c.getCursor("end"), h = c.getTokenAt({ line: u.line, ch: u.ch || 1 }), d = c.getLineHandle(u.line),
               p = r(c, u.line, d, h);
            if ("single" === p) {
         ...
         function B(e) {
            e = e || {}, e.parent = this;
            /*var t = !0;
            if (e.autoDownloadFontAwesome === !1 && (t = !1), e.autoDownloadFontAwesome !== !0) for (var n = document.styleSheets, r = 0; r < n.length; r++) n[r].href && n[r].href.indexOf("//maxcdn.bootstrapcdn.common/font-awesome/") > -1 && (t = !1);
            if (t) {
