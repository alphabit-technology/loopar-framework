...
import {loopar} from "@loopar/loopar";
...
export default class Dialog extends React.Component {
   ...
   render(body) {
      ...
      return(
         <>
            <div className={`modal-backdrop fade ${open ? 'show' : ''}`} style={{ zIndex: zIndex, display: open ? 'block' : 'none'}}/>
            <div 
            ...
            />
            <div className={`modal-dialog modal-${this.props.size || "md"} modal-dialog-${this.props.position || 'centered'} ${this.props.scrollable ? 'modal-dialog-scrollable' : ''}`} role="document">
               <div className="modal-content">
                  ...
                  {hasFooter ? <div className="modal-footer">
                     {this.buttons.map(b => {
                        return <button type="button" className={b.className || `btn btn-${b.type || 'primary'}`} onClick={() => {
                        ...
                        }}>{b.content || b.text || b.label}</button>
                     })}
                  </div> : null}
               </div>
            </div>
   ...
   render(){
      return super.render(
         <div className="form-group">
            <label htmlFor="prompt-input">{this.props.label || ""}</label>
            <input
               type="text"
