                  ...
                  nav({ className: "stacked-menu" }, [
                     ul({ className: "menu" }, [
                        ...
                        /*menuItems.map((item) => {
                           ...
                           return li({ className: `menu-item ${active ? "active" : ""}`, ref: self => this[item.page] = self }, [
                              a({
               ...
               div({ className: "container" }, [
                  ...
                  div({ 
                     ...
                     ul({ className: "navbar-nav" }, [
                        ...
                        menuItems.map((item) => {
                           const active = item.page === loopar.currentPageName;
                           return li({ className: `nav-item mr-lg-2 ${active ? "active" : ""}`, ref: self => this[item.page] = self }, [
                              a({
