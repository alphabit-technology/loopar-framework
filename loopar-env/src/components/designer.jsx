...
export default class Designer extends Component {
                  ...
                  content={[
                     <div className="form-control bg-light" style={{ minHeight: 100, padding: 0 }}>
                        <pre style={{ padding: 10, position: "relative", height: "100%" }}>
                           <code className="text-success" style={{ position: "absolute", height: "100%", width: "calc(100% - 10px)" }}>
   ...
   render() {
      ...
      return super.render([
         ...
         <div className={this.props.designer ? "p-2" : ""} style={{ marginBottom: "-20px" }}>
            <Tabs
            ...
            >
               {[
                  {
                     label: <h6>{[<span className="oi oi-brush mr-2" />, "Designer"]}</h6>,
                     name: this.props.meta.data.name + "_designer-tab",
                     key: this.props.meta.data.name + "_designer-tab",
                     content: [
                        <div className={`design design-area ${className}`} style={{ padding: 0, margin: 0 }}>
                           <div
                  ...
                  {
                     label: <h6>{[<span className="fa fa-code mr-2" />, "Model"]}</h6>,
