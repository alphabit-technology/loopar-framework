...
export default class StripeClass extends Component {
   ...
   render(content = null) {
      ...
      return (
         <>
            <button className={this.props.buttonClassName || "btn btn-primary btn-block"} onClick={(e) => {
               e.preventDefault();
               e.stopPropagation();
               this.setState({
                  open: true
            ...
            >
               ...
               <form className="card-form" action={data.action} method={data.method} ref={form => {
                  ...
                  <div className="card-body">
                     <div className="row">
                        <div className="col-12">
                           ...
                           <div className="form-group">
                              <div className="row">
                                 <div className="form-control" style={{ height: 55 }}>
                                    <div id="card-element" aria-label="Credit or debit card" style={{ color: "#fff" }} ref={card => {
                                       if (card) {
                                          this.card = card;
                                       }
                                    }}></div>
                           ...
                           <div className="form-group">
                              <div className="row">
                                 <div role="alert" ref={messageContainter => this.messageContainter = messageContainter}></div>
                              </div>
                           </div>
                        </div>
