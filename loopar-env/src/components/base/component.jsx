...
//const BaseComponent = await import("./base-component.jsx");
...
export default class Component extends BaseComponent {
   ...
   render(content) {
      ...
      return super.render(content || this.props.children);
      super.render(
               ...
               <div className="element-title">
                  ...
                  <div className="btn-group title-description">
                     <a className="btn btn-default btn-xs element-title-text">
                        <span>{(this.props.elementTitle || this.props.element).toString().split(".")[0].toUpperCase()}</span>
                     </a>
                  </div>
               </div>
            ) : null}
