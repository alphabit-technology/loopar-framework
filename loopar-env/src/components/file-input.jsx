   ...
   render() {
      ...
      return super.render([
         ...
         >
            ...
            >
               {this.state.dropping ? [
                  <span className="file-drop-zone-icon">Drop files here!</span>,
               ] : [
                  files.length === 0 ? [
                     this.state.loaded ? [
                        <p className="file-drop-zone-title mb-2">
                           <small className="file-drop-zone-subtitle">Drag & Drop or upload from</small>
                        </p>,
                              ...
                              <div className="col-12">
                                 {(this.props.origins || this.origins).map((origin) => {
                                    ...
                                    return (
                                       ...
                                       >
                                          <i className={`fa ${origin.icon} mr-2`}></i>
                                          {origin.name}
                                       </button>
                                    );
                                 })}
                     ...
                     <div className="row">
                        <div className="col">
                           <div className="has-clearable"></div>
                        </div>
