...
class BaseTable extends Div {
                  ...
                  return (
                     <div className="thead-dd dropdown">
                        ...
                        <div className={`dropdown-menu`}>
                           ...
                           <div className="dropdown-divider"></div>
                           <a
                              className={`dropdown-item ${rowsSelected === 0 ? "disabled" : ""
                                 }`}
                              href="#"
   ...
   getTableRender(_columns, rows) {
      ...
      return (
         <table
            className={`table table-${this.gridSize} mb-0 table-hover bordered`}
            style={{}}
         >
            <thead>
               <tr>
                     ...
                     <td colSpan={columns.length}>
                        <div className="card empty-state">
                           <div className="empty-state-container">
                              ...
                              <div className="empty-state-text h6">No rows to show</div>
                           </div>
                        </div>
                     </td>
                  </tr>
            ...
            {rows.length === 0 ? (
               ...
               <div className="col-12">
                  <div
                     ...
                     style={{
                        gridTemplateColumns: `repeat(auto-fit, minmax(${this.docRef.cardSize || 150}px, 1fr))`,
                     }}
                  >
                     {rows.map((row) => {
                        ...
                        return (
                           <div className="grid-item" style={{ maxHeight: this.docRef.cardSize || 180 }}>
                              <div className="card text-dark bg-light metric-bordered" style={{ height: '100%' }}>
                                 {this.docRef.gridTemplate ? (
   ...
   render() {
      ...
      return super.render([
         <div className="feed-post card" style={{ height: "100%" }}>
                  ...
                  <div className="metric-row metric-flush" style={{ paddingLeft: 5, paddingRight: 5, marginBottom: -20 }}>
                     {this.data.label ? (
                        <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                           <div className='d-flex align-items-center'>
                              <span className='mr-auto'>{this.data.label}</span>
                           </div>
                        </div>
                     ) : null}
                     ...
                     <div className='align-self-start ml-auto btn-toolbar'>
                        <div className='btn-group' style={{ marginTop: -5 }}>
                           {selectedRowsCount > 0 ? (
                              <button type='button' className='btn btn-light text-danger' onClick={() => this.bulkRemove()}>
                                 <i className='oi oi-trash'></i>
                                 <span className='ml-1'>Remove ({selectedRowsCount})</span>
                              </button>
                           ) : null}
                           {this.isEditable ? (
                              <button type='button' className='btn btn-light' onClick={() => this.addRow()}>
            ...
            <div className='card-body border-top' style={{
            ...
            <div className='card-footer'>
               ...
               {this.hasPagination ? (
                  <Pagination pagination={this.pagination} app={this} />
               ) : null}
            </div>
         </div>
      ]);
                  ...
                  return (
                     <div className="media align-items-center">
                        ...
                        <div className="media-body">
                           <a key={row.name + "_description"} href={`update?documentName=${row.name}`}>
                              {row.description || row.name}
                           </a>
                           <small className="d-block text-muted">{row.name}</small>
                        </div>
                     </div>
                  );
               },
